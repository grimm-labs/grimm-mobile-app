  ...
  return (
    <View className="mx-4 mt-2 rounded-lg">
      ...
      <View className="py-6">
        ...
        <View className="mb-4">
          <Text className="text-center text-lg font-medium text-gray-600">{isBalanceHide ? '********' : `XAF ${balance.usd.toLocaleString()}`}</Text>
        </View>
        <View className="flex flex-row items-center justify-center">
          <Ionicons name="arrow-up-circle" size={16} color={colors.success[600]} />
          <Text className="ml-2 text-center text-sm font-medium text-success-600">XAF 139,300 (+5.53%)</Text>
        </View>
      </View>
