...
export const Language = ({ ...props }: SvgProps) => (
  <Svg width={100} height={71} {...props}>
    <G fill="none" fillRule="evenodd">
      <Path d="M55.684 0H3.319A3.319 3.319 0 0 0 0 3.324V39.4a3.319 3.319 0 0 0 3.32 3.324h10.207V57l14.048-14.276h28.109A3.32 3.32 0 0 0 59 39.4V3.324A3.32 3.32 0 0 0 55.684 0" fill="#FC6276" />
      <Path
        ...
        fill="#FFF"
      />
      <Path d="M96.682 14H44.316A3.32 3.32 0 0 0 41 17.318v36.08a3.321 3.321 0 0 0 3.316 3.323h28.11L86.473 71V56.721h10.208A3.32 3.32 0 0 0 100 53.398v-36.08A3.317 3.317 0 0 0 96.682 14" fill="#192332" />
      <Text
