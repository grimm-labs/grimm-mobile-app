        ...
        <ScrollView className="flex-1" contentContainerStyle={{ flexGrow: 1 }}>
          <View className="flex-1">
            ...
            <View className="mt-6 items-center">
              ...
              <Text className="mt-6 text-center text-2xl font-medium text-red-500">Attention</Text>
              <Text className="mt-4 text-center text-lg">Please read the following carefully before viewing your recovery phrase.</Text>
            </View>
